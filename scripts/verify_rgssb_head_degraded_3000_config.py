#!/usr/bin/env python3
"""Verify the 3000-sample RG-SSB + head degraded LaSOT debug config."""
    ...
    if "pycocotools.coco" not in sys.modules:
        ...
        class _COCO:
            def __init__(self, *args, **kwargs):
                raise RuntimeError("COCO is not used by the 3000-sample RG-SSB verifier.")
...
def main() -> None:
    ...
    config_path = (
        ...
        / "experiments"
        / "ostrack"
        / "vitb_256_mae_ce_32x4_ep300_rgssb_head_train_lasot_degraded_3000_debug.yaml"
    )
