...
\begin{itemize}
    \item broader OTB: 13 sequences and 52 sequence-condition pairs~\cite{wu2013otb};
    \item expanded UAV123: 16 sequences and 64 pairs~\cite{mueller2016uav123};
    \item corrected expanded NFS: 32 sequences and 128 pairs~\cite{galoogahi2017nfs}.
\end{itemize}
