...
| Tracking Under Degraded Observations and Present-Work Positioning | `zhong2024llot`, `wu2024mambanut` |
...
| Tracking Under Degraded Observations and Present-Work Positioning | 2 | 2 |

Unique sources cited in Related Work after final bibliography audit: 21.

## Peer-Reviewed Versus Preprint Count

For the 21 unique Related Work sources:

- Peer-reviewed or accepted peer-reviewed: 13.
- ArXiv-only or final venue not independently confirmed: 8.
- Local unpublished evidence cited in submission: 0.
...
- `invtrack_local`: removed from submission-facing citations because only local placeholder-PDF metadata was available and no authoritative publication/preprint record was verified.
- `liu2024vmamba`: upgraded to NeurIPS 2024 spotlight using verified arXiv metadata; volume, pages, and DOI not reported.
